    ...
    axios.post(loginUrl, formData)
      .then(res => {
        if (res.data.bool === true) {
          ...
          localStorage.setItem('staffId', res.data.staff_id); // Optional: if needed later
        ...
        <div className="row g-0">
          ...
          <div className="col-lg-6 p-5 bg-white">
            <div className="text-center mb-5">
              <h3 className="fw-bold text-dark mb-2">Staff Login</h3>
            ...
            <div className="mt-5 text-center">
              <p className="text-muted">
                <small>
                Need access? Contact the Main Administrator to create your staff account.
                </small>
