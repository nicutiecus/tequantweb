...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-dummy-key-for-build-12345')
...
CSRF_TRUSTED_ORIGINS = [
    "https://api.tequant.ng",
    "https://tequant.ng",       
    "http://127.0.0.1:8000",    # Keep this for local testing
]
